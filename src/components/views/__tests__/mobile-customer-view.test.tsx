...
describe('MobileCustomerView - Responsive 2-Column Grid', () => {
  beforeEach(() => {
  ...
  test('renders mobile customer view with 2-column grid layout', () => {
  ...
  test('renders product cards with mobile-optimized sizing', () => {
    ...
    productCards.forEach(card => {
      expect(card).toHaveClass('mobile-product-card');
    });
  });

  test('displays touch-friendly tap targets', () => {
    renderMobileCustomerView();
    ...
    addButtons.forEach(button => {
      expect(button).toHaveClass('mobile-touch-button');
  ...
  test('handles store closed state', () => {
  ...
  test('renders consistent card heights', () => {
    renderMobileCustomerView();
  ...
  test('renders with proper spacing for mobile', () => {
    renderMobileCustomerView();
    
    const gridContainer = screen.getByTestId('mobile-product-grid');
    expect(gridContainer).toHaveClass('gap-3'); // Mobile-optimized gap
  });
