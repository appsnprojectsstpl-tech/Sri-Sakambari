...
const translations: Translations = {
    ...
    whatsAppMessage: { en: 'Hey! I just ordered fresh vegetables from Sri Sakambari eVeggie Market. You should check them out!', te: 'హే! నేను శ్రీ శాకాంబరి ఈ-వెజ్జీ మార్కెట్ నుండి తాజా కూరగాయలను ఆర్డర్ చేసాను. మీరు కూడా చూడండి!' },
    whatsappOrderConfirmation: { en: 'Thank you for your order from Sri Sakambari eVeggie Market! Your order number is {ORDER_ID}.', te: 'శ్రీ శాకాంబరి ఈ-వెజ్జీ మార్కెట్ నుండి ఆర్డర్ చేసినందుకు ధన్యవాదాలు! మీ ఆర్డర్ నంబర్ {ORDER_ID}.' },
    ...
    endDate: { en: 'End Date', te: 'ముగింపు తేదీ' },
    saving: { en: 'Saving...', te: 'సేవ్ చేస్తోంది...' },
    update: { en: 'Update', te: 'అప్‌డేట్ చేయండి' },
    create: { en: 'Create', te: 'సృష్టించండి' },
    selectDays: { en: 'Select Days', te: 'రోజులు ఎంచుకోండి' },
    enterArea: { en: 'Enter area', te: 'ప్రాంతాన్ని నమోదు చేయండి' },
    selectProduct: { en: 'Select product', te: 'ఉత్పత్తిని ఎంచుకోండి' },
    addItem: { en: 'Add Item', te: 'వస్తువును జోడించండి' },
    enterNotes: { en: 'Enter notes', te: 'నోట్స్ నమోదు చేయండి' },
    noSubscriptions: { en: 'No subscriptions found', te: 'చందాలు కనుగొనబడలేదు' },
    createFirstSubscription: { en: 'Create First Subscription', te: 'మొదటి చందాన్ని సృష్టించండి' },
    unknownProduct: { en: 'Unknown Product', te: 'తెలియని ఉత్పత్తి' },
    units: { en: 'units', te: 'యూనిట్లు' },
    active: { en: 'Active', te: 'చురుకైన' },
    paused: { en: 'Paused', te: 'నిలిపివేయబడింది' },
    edit: { en: 'Edit', te: 'సవరించండి' },
    pause: { en: 'Pause', te: 'నిలిపివేయండి' },
    resume: { en: 'Resume', te: 'పునఃప్రారంభించండి' },
